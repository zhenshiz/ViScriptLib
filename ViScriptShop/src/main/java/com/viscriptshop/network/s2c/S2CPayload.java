...
public class S2CPayload {
    ...
    public static final String SYNC_PLAYER_MONEY = MOD_ID + "sync_player_money";
    ...
    @RPCPacket(SYNC_PLAYER_MONEY)
    public static void syncPlayerMoney(RPCSender sender, ShopRegistries.Money money) {
        ShopRegistries.clientPlayerMoney = money;
    }
}
