...
public class ShopInspectorView extends View {
    ...
    @Nullable
    private CategoryInfo.ShopType merchantShopType;
    ...
    public ShopInspectorView(ShopEditor editor) {
        ...
        this.merchantButton = createScopeButton("viscript_shop.editor.inspector.merchant", () -> {
            if (merchantInfo != null && merchantShopType != null) inspectMerchant(merchantInfo, merchantShopType);
        });
    ...
    public void inspectMerchant(MerchantInfo merchantInfo, CategoryInfo.ShopType shopType) {
        ...
        this.merchantShopType = shopType;
        this.scope = Scope.MERCHANT;
        clearInspector();

        ConfiguratorGroup configurator = (ConfiguratorGroup) merchantInfo.createConfigurator(shopType).layout(layout -> {
            layout.widthPercent(100);
        });
