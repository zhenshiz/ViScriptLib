...
public class WorkBenchView extends View {
    ...
    private void loadCanvas() {
        ...
        if (entry == null || RecipeEditorTypes.require(entry.getType()).canvasSupplier() == null) {
            canvas = null;
            return;
        }
    ...
    private void updateStatus() {
        ...
        var warningKey = canvas != null && RecipeCanvas.selectedContainsUnsupportedIngredients
