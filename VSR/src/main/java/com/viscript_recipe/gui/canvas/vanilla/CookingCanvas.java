    ...
    public void buildRecipeProperties(UIElement content) {
        ...
        content.addChildren(
                ...
                RecipeEditorUi.fieldGroup("viscript_recipe.config.cooking.experience",
                        RecipeEditorUi.floatField(data.getExperience(), 0, Integer.MAX_VALUE, value -> {
                ...
                RecipeEditorUi.fieldGroup("viscript_recipe.config.cooking.cooking_time",
                        RecipeEditorUi.intField(data.getCookingTime(), 1, 72000, value -> {
                            data.setCookingTime(value);
                            updateTimeLabel();
                        }))
        );
    }
